...
# Load models
diabetes_model = pickle.load(open('D:/Internship/My APK/diabetes_model.sav', 'rb'))
heart_disease_model = pickle.load(open('D:\Internship/My APK/heart_diseaseLR.sav', 'rb'))
parkinson_model = pickle.load(open('D:/Internship/My APK/ParkinsonsSVM.sav', 'rb'))
